...
REPLY_TEMPLATES = {
    ...
    "waitlist_info": "ตอนนี้คิวประมาณ 5-10 นาทีค่ะ ลูกค้าสามารถแจ้งชื่อ-เบอร์โทรไว้ล่วงหน้าเพื่อจองคิวได้เลยค่ะ",
    "wifi_info": "รหัส WiFi ของร้านคือ MOS123456 ค่ะ สามารถสอบถามพนักงานหน้าร้านเพิ่มเติมได้เลยค่ะ",
    ...
    "corkage_info": "ลูกค้าสามารถนำเครื่องดื่ม/เค้กมาเองได้ค่ะ ทางร้านมีค่า Corkage 20 ต่อขวด/ชิ้นค่ะ",
